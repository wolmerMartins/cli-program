...
const questions = [
    { type: 'list', name: 'coffeeType', message: 'Choose your coffee type', choices: values.typesPlain },
    ...
    { type: 'confirm', name: 'cold', message: 'Do you prefer your coffe to be cold?', default: false },
